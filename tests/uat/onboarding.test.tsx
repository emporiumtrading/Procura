...
test.describe('User Acceptance Testing - New User Onboarding', () => {
  test('complete account creation flow', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="email-verification"]')).toContainText('Check your email for verification link');
    ...
    await expect(page.locator('[data-testid="onboarding-welcome"]')).toContainText('Welcome to Procura!');
  ...
  test('account management and settings', async ({ page }) => {
    ...
    await page.fill('[data-testid="slack-webhook"]', 'https://hooks.slack.com/services/T123/B456/XYZ');
